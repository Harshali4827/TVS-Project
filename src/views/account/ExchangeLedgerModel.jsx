...
// const ExchangeLedgerModel = ({ show, onClose, brokerData }) => {
...
//       const response = await axiosInstance.post(`/broker-ledger/${formData.brokerId}/transactions`, paymentData);
...
//       setFormData({
//         brokerId: brokerData?._id || '',
//         totalAmount: brokerData?.discountedAmount || 0,
//         balanceAmount: brokerData?.discountedAmount || 0,
//         modeOfPayment: '',
//         amount: '',
//         remark: '',
//         cashLocation: '',
...
//           <CModalTitle className="text-white">Exchange Receipt</CModalTitle>
//         </CModalHeader>
//         <CModalBody>
...
//   <h5 className="mb-0">
//     Exchange Broker: <strong>{brokerData?.broker?.name || ''}</strong>
//   </h5>
// </div>
//           <hr></hr>
//           <CRow className="mb-3">
            ...
            <CRow className="mb-3">
              <CCol md={6}>
                ...
                >
                  ...
                  {brokerData?.bookings?.map(booking => (
