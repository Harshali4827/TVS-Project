...
//         <CModalHeader>
//           <CModalTitle>Booking Number - {kycData.bookingNumber || 'Customer'}</CModalTitle>
//         </CModalHeader>
//         <CModalBody>
...
//                   <p>
//                     <strong>Name:</strong> {kycData.customerName || 'N/A'}
//                   </p>
//                   <p>
//                     <strong>Chassis Number:</strong> {kycData.chassisNumber || 'N/A'}
//                   </p>
//                 </div>
//               </CCol>
//             </CRow>
...
//                 <DocumentCard title="Aadhar Front" document={kycData.aadharFront} />
//               </CCol>
//               <CCol md={6} className="mb-4">
//                 <DocumentCard title="Aadhar Back" document={kycData.aadharBack} />
//               </CCol>
//             </CRow>

//             <CRow>
//               <CCol md={6} className="mb-4">
//                 <DocumentCard title="PAN Card" document={kycData.panCard} />
//               </CCol>
//               <CCol md={6} className="mb-4">
//                 <DocumentCard title="Vehicle Photo" document={kycData.vPhoto} />
//               </CCol>
//             </CRow>

//             <CRow>
//               <CCol md={6} className="mb-4">
//                 <DocumentCard title="Chassis Number Photo" document={kycData.chasisNoPhoto} />
//               </CCol>
//               <CCol md={6} className="mb-4">
//                 <DocumentCard title="Address Proof 1" document={kycData.addressProof1} />
//               </CCol>
//             </CRow>
...
//               <CRow>
//                 <CCol md={6} className="mb-4">
//                   <DocumentCard title="Address Proof 2" document={kycData.addressProof2} />
//                 </CCol>
//               </CRow>
//             )}
//           </div>
...
//   rtoId: PropTypes.string.isRequired,
...
const KYCDocuments = ({ open, onClose, kycData, refreshData, rtoId }) => {
  ...
  // Extract documents from either nested kycDocuments or root object
