    ...
    <table>
      ...
      ${priceComponentsWithGST
        ...
        <tr>
          ...
          <td class="text-right">${(component.gstRate * 50).toFixed(2)}%</td>
          <td class="text-right">${component.cgstAmount.toFixed(2)}</td>
          <td class="text-right">${(component.gstRate * 50).toFixed(2)}%</td>
          <td class="text-right">${component.sgstAmount.toFixed(2)}</td>
          <td class="text-right">${component.discount || '0.00'}</td>
