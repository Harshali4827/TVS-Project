...
//       }
//     };
//     delete payload.updates.note; // Remove note from updates as it's a separate field
...
//             <TextField label="Current Color" value={updateData.color} variant="outlined" fullWidth disabled />
//           </div>
//         </div>
...
//             <TextField
//               label="Payment Type"
//               value={editedUpdates.payment?.type || ''}
//               onChange={(e) => handleFieldChange('payment.type', e.target.value)}
//               variant="outlined"
//               fullWidth
//               select
  ...
  useEffect(() => {
    if (updateData) {
      ...
      if (updateData.model.id) {
        fetchModelColors(updateData.model.id);
      }
    }
  }, [updateData]);
        ...
        <div style={{ marginBottom: '20px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px', marginBottom: '16px' }}>
            <FormControl fullWidth>
              <InputLabel>Requested Color</InputLabel>
              <Select
                value={editedUpdates.color || ''}
                onChange={(e) => handleFieldChange('color', e.target.value)}
                label="Requested Color"
