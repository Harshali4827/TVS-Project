...
//     try {
//       let endpoint = `/models/with-prices?branch_id=${branchId || ''}`;
//       if (customerType) {
//         endpoint += `&customerType=${customerType}`;
//       }
...
//                               No models available for this branch
//                             </option>
//                           )}
//                         </CFormSelect>
//                       </CInputGroup>
...
//                 {formData.model_id && selectedModelHeaders.length > 0 && (
...
//                               label={`${header.header_key} (₹${header.value})`}
