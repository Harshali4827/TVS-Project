...
//     try {
//       const response = await axiosInstance.get(`/cash-vouchers/status/pending`);
...
//     try {
//       const response = await axiosInstance.get(`/cash-vouchers/status/approved`);
...
//     try {
//       const response = await axiosInstance.get(`/cash-vouchers/status/rejected`);
...
//   const handleStatusUpdate = async (voucherId, status) => {
//     try {
//       const result = await Swal.fire({
//         title: 'Are you sure?',
//         text: `You are about to ${status} this voucher`,
//         icon: 'warning',
...
//         Swal.fire(`${status.charAt(0).toUpperCase() + status.slice(1)}!`, `Voucher has been ${status.toLowerCase()}.`, 'success');

//         fetchData();
//       }
//     } catch (error) {
//       console.log('Error updating status', error);
//       Swal.fire('Error!', `Failed to ${status} voucher.`, 'error');
//     }
//   };
//   return (
...
//                             <MenuItem onClick={() => handleStatusUpdate(item._id, 'Approved')}>Approved</MenuItem>
//                             <MenuItem onClick={() => handleStatusUpdate(item._id, 'Rejected')}>Reject</MenuItem>
//                           </Menu>
//                         </td>
//                       </tr>
//                     ))
...
const handleStatusUpdate = async (status) => {
  try {
    ...
    const response = await axiosInstance.put(
      `/cash-vouchers/${selectedVoucher._id}`,
      formData,
      {
